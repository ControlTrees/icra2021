...
namespace gazebo
{
class LGPPedestrianPlugIn : public ModelPlugin
{
public:
    LGPPedestrianPlugIn();
...
private:
    ...
    visualization_msgs::Marker create_pedestrian(nav_msgs::Odometry msg) const;
...
GZ_REGISTER_MODEL_PLUGIN(LGPPedestrianPlugIn)
}
